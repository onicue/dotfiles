...
function M.get_colors(base, theme_name)
    local path = "core.base46.themes." .. theme_name
...
function M.load_theme(user_opts)
    local opts = {
        ...
        theme = "",
        transparency = false,
        integrations = require("core.base46.integrations"),
    }
    ...
    -- term hls
    require("core.base46.term").set_hls(colors)

    -- get hls
    local hls = require("core.base46.highlights").get_hls(colors, opts.transparency, opts.integrations)
